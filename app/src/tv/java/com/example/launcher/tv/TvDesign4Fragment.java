...
public class TvDesign4Fragment extends Fragment implements TvGridAdapter.OnAppClickListener {
	private final AppRepository repository = new AppRepository();

	@Nullable @Override public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		View root = inflater.inflate(R.layout.tv_design4, container, false);
